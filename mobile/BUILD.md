...
- **El icono adaptativo de Android.** `app.json` usa `logo-candela.png` como
  `adaptiveIcon.foregroundImage`, y Android recorta esa imagen a un círculo o
  a un cuadrado redondeado quedándose con **el 66% central**. Si la llama
  llega hasta el borde del lienzo, en el teléfono aparecerá cortada. Se
  arregla con una copia del logo al 60% de su tamaño, centrada sobre un
  lienzo transparente de 1024×1024.
